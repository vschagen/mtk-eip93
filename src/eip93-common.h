...
/* descriptor flags */
#define MTK_DESC_LAST			BIT(31)
#define MTK_DESC_FINISH			BIT(30)
#define MTK_DESC_SKCIPHER		BIT(29)
#define MTK_DESC_AEAD			BIT(28)
#define MTK_DESC_AHASH			BIT(27)
#define MTK_DESC_FAKE_HMAC		BIT(26)
#define MTK_DESC_PRNG			BIT(25)
#define MTK_DESC_IPSEC			BIT(24)
...
#define IS_AEAD(flags)			(flags & MTK_DESC_AEAD)
